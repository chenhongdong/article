  (function(){
    ...
    So.Util = {
        ...
        createIcon: function(type, stype){
            var iconConf = {
                'poi': function(stype){
                    stype = stype || 0;
                    return {
                        src : '/img/marker_poi.png?v=20151215',
                        width: 20,
                        height: 35,
                        origin: {
                            x:0,
        ...
        hasQuery: function(c) {
            var b = ["bus=", "k=", "q=", "p=", "r=", "from=", "to=", "pid=", 'start=', 'end=', 'loc=', 'city=', 'showtf=','pguid=','id=','type=','keyword='];
            var a = false;
